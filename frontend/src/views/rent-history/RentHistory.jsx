  ...
  return (
    <div className='rent-history__wrapper'>
      ...
      <div className='rent-history'>
        {rentHistory.length > 0 && rentHistory[0].rentStatus === 'rented'? (
        ...
        {rentHistory.map((historyItem, index) => (
          <div className='rent-history__single-rental' key={index}>
            ...
            <p><strong>Data wypożyczenia:</strong> {historyItem.rentalDate}</p>
            <p><strong>Data zwrotu:</strong> {historyItem.returnDate? `Zwrócony: ${historyItem.returnDate}` : 'Nie zwrócony'}</p>
